    ...
    <div className="min-h-screen bg-[#051111] text-brand-text font-sans overflow-x-hidden selection:bg-cyan-500 selection:text-white">
      ...
      {content?.organization && content.organization.length > 0 && (
        <section className="relative z-10 py-24 px-8 border-y border-white/5">
          <div className="max-w-7xl mx-auto">
            <h3 className="text-3xl font-black uppercase tracking-tighter mb-12 text-center text-cyan-500">Health Personnel</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
              {content.organization.map((member) => (
                <div key={member.id} className="text-center group">
                  ...
                  <p className="text-[9px] font-black text-cyan-500 uppercase tracking-[0.2em] mt-1">{member.role}</p>
                </div>
              ))}
            </div>
          </div>
